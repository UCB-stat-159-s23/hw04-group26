# utility file containing whiten, write_wavfile, reqshift functions from the python notebook, and a new plotting utility 
import numpy as np
...
def plot_func(time, timemax, SNR, pcolor, det, eventname, fs, plottype, tevent, strain_whitenbp,template_match,template_fft, datafreq, d_eff, freqs, data_psd):
